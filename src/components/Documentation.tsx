  ...
  <>
    <div className="flex flex-col md:flex-row justify-center card xl:w-[1300px] lg:h-[840px] ">
      ...
      <div className="w-full">
        ...
        <div className="relative"><p className="text-dark-gray">asuahsyha</p></div>
      </div>
    </div>
    ...
    <div className="flex flex-col md:flex-row justify-center card xl:w-[1300px] lg:h-[840px] ">
      ...
      <div className="w-full flex flex-col items-start justify-center object-contain ">
        <img src={bobbleMaskBgCircle} className="relative lg:absolute md:-w-[360px] xl:w-auto" alt="Booble background"/>
        <div className="relative"><p className="text-dark-gray">asuahsyha</p></div>
      </div>
