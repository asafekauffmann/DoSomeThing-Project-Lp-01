import firstWare from '../assets/images/first-wave.svg'

const  MyHero = () => (
  <div className="flex flex-col items-center justify-end bg-dark-blue h-auto ">

    <div className="pt-36 pb-20 object-contain">
      <h1 className="text-white text-6xl font-normal pb-3">Create some task</h1>
      <h1 className="text-light-blue text-6xl font-semibold pb-3">More faster them all</h1>
      ...
      <div className="inline max:w-[460px] bg-white rounded-3xl py-3"> 
        ...
        <button className="bg-light-blue text-white p-3 rounded-3xl">SEND EMAIL</button>
      </div>
    </div>
